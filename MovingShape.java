...
public abstract class MovingShape {
    ...
    public abstract class MovingPath {
    		...
    		public static final int BOUNCING = 1;
    ...
    public class FallingPath extends MovingPath {
        private double sam = 0, sstx =0, sinDeltax = 0;


        public FallingPath() {
            sam = Math.random() * 30; //set amplitude variables
            sstx = 0.6; //set step variables
            deltaY = 6;
            sinDeltax = 0;
       }

       public void move() {
           sinDeltax = sinDeltax + sstx;
           x = (int) Math.round(x + sam * Math.sin(sinDeltax));
           y = y + deltaY;
           if (y > marginHeight) 
               y = 0;
       }
