...
public class AnimationPanel extends JComponent implements Runnable {
    ...
    //private MovingRectangle[] shapes  = new MovingRectangle[MAX_COUNT];;		// the ArrayList which stores a list of shapes
    private ArrayList<MovingShape> shapes = new ArrayList<MovingShape>(Arrays.asList());
    ...
    public AnimationPanel() {
		//shapes = new MovingRectangle[MAX_COUNT]; //create the ArrayList to store shapes
    		//ArrayList<MovingShape> arrayList = new ArrayList<MovingShape>(Arrays.asList(shapes));
    ...
    protected void createNewShape(int x, int y) {
        ...
        switch (currentShapeType) {
            ...
            case 1:{
            		...
            		shapes.add ( new MovingSquare(x, y, newWidth,	newWidth, marginWidth, marginHeight, currentBorderColor, currentFillColor, currentPath));
                break;
            }
            case 2:{
	...
	public void setCurrentBorderColor(Color bc) {
		...
		for (MovingShape i : shapes)
			if ( i.isSelected())
				i.setBorderColor(currentBorderColor);
	}
    ...
    public void setCurrentFillColor(Color fc) {
		...
		for (MovingShape i : shapes)
			if ( i.isSelected())
				i.setFillColor(currentFillColor);
    }
